...
exports.HutbSimulationMonitorProvider = void 0;
const vscode = __importStar(require("vscode"));
const http = __importStar(require("http"));
const https = __importStar(require("https"));
const fs = __importStar(require("fs"));
const path = __importStar(require("path"));
class HutbSimulationMonitorProvider {
    constructor(context) {
        this.samples = [];
        this.mockStep = 0;
        this.disposed = false;
    ...
    resolveWebviewView(webviewView) {
        ...
        const echartsUri = webviewView.webview.asWebviewUri(vscode.Uri.file(path.join(this.context.extensionPath, 'node_modules', 'echarts', 'dist', 'echarts.min.js')));
    ...
    start() {
        ...
        const intervalMs = vscode.workspace.getConfiguration('hutb.monitor').get('pollIntervalMs', 1000);
    ...
    async pollOnce() {
        ...
        const keepSamples = config.get('historySize', 120);
        const allowMock = config.get('useMockWhenDisconnected', true);
        let sample;
        try {
            sample = endpoint
...
exports.HutbSimulationMonitorProvider = HutbSimulationMonitorProvider;
HutbSimulationMonitorProvider.viewType = 'hutb.simulationMonitor';
...
//# sourceMappingURL=simulationMonitor.js.map